...
INSERT INTO "new_Slide" ("createdAt", "customPrompt", "errorMessage", "finalImagePath", "finalPrompt", "generatedImagePath", "id", "order", "overlaySubtext", "overlayText", "processedImagePath", "referenceImagePath", "referenceType", "slidePurpose", "slideshowId", "status", "textAccentColor", "textAlign", "textBoxEnabled", "textBoxOpacity", "textColor", "textOverlayEnabled", "textPosition", "textShadow", "textSize", "textStyle", "updatedAt", "variationAngle", "variationDirection") SELECT "createdAt", "customPrompt", "errorMessage", "finalImagePath", "finalPrompt", "generatedImagePath", "id", "order", "overlaySubtext", "overlayText", "processedImagePath", "referenceImagePath", "referenceType", "slidePurpose", "slideshowId", "status", "textAccentColor", "textAlign", "textBoxEnabled", "textBoxOpacity", "textColor", "textOverlayEnabled", "textPosition", "textShadow", "textSize", "textStyle", "updatedAt", "variationAngle", "variationDirection" FROM "Slide";
DROP TABLE "Slide";
